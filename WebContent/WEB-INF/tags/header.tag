...
<script>
	...
	function flushAll(){
		...
		$.getJSON('${pageContext.request.contextPath}/flushall.htm' , function(data){
	...
	function flushDB(){
		...
		$.getJSON('${pageContext.request.contextPath}/flushDb.htm' , function(data){
			if(data.statu.toLowerCase() == 'ok'){
				message('flushDB操作成功') ;
			} else {
				message('flushDB操作失败') ;
		...
		<div class="container">
			...
			<div class="nav-collapse">
				<ul class="nav">
					...
					<li><a href="${pageContext.request.contextPath}/keys.htm">keys</a></li>
					<li><a href="${pageContext.request.contextPath}/config/toConfigDetail.htm">redis-config.xml</a></li>
					<li><a href="${pageContext.request.contextPath}/server/redisServer.htm">redis节点管理</a></li>
					<li><a href="${pageContext.request.contextPath}/monitor.htm">redis实时监控</a></li>
				</ul>
